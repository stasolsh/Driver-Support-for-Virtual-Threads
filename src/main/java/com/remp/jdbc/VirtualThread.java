...
public class VirtualThread {
    ...
    private static final String QUERY = "SELECT * FROM SH.CUSTOMERS WHERE CUST_ID = 49671";
    private final static Logger LOGGER = Logger.getLogger("com.remp.jdbc.VirtualThread");
    ...
    public static void main(String args[]) throws SQLException {
        ...
        var threads = IntStream.range(0, 1_500).mapToObj(i -> Thread.startVirtualThread(() -> {
            try {
                ...
                System.out.println(STR."Query #: \{i}");
    ...
    private static void doSQLWork(Connection conn) throws SQLException {
        ...
        try (Statement statement = conn.createStatement();
             ResultSet resultSet = statement.executeQuery(VirtualThread.QUERY)) {
